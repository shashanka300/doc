...
def load_data_and_labels(fashion_data_file, finance_data_file, law_data_file, lifestyle_data_file):
    ...
    fashion_examples = list(open(fashion_data_file, "r",encoding="utf8").readlines())
    fashion_examples = [s.strip() for s in fashion_examples]
    finance_examples = list(open(finance_data_file, "r",encoding="utf8").readlines())
    finance_examples = [s.strip() for s in finance_examples]
    law_examples = list(open(law_data_file, "r",encoding="utf8").readlines())
    lifestyle_examples = list(open(lifestyle_data_file, "r",encoding="utf8").readlines())
